...
ok: backup_2026-05-22_12-50.json saved.
```
...
- **Manual backup/restore** to `/Download/MyTasks/` as timestamped JSON files
...
- **UI**: pure HTML/CSS/JS, no frameworks — single file `app/src/main/assets/notes_app.html`
- **Container**: Android WebView wrapped in Kotlin `MainActivity`
- **Backup bridge**: native `AndroidBackup` JS interface using MediaStore Downloads API
